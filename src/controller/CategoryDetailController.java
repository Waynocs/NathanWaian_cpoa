...
public class CategoryDetailController implements Initializable {
    ...
    public static Tab createControl(Category categ) {
        try {
            URL fxmlURL = CategoryDetailController.class.getResource("../view/CategoryDetail.fxml");
            FXMLLoader fxmlLoader = new FXMLLoader(fxmlURL);
            var control = fxmlLoader.<TabPane>load();
            var controller = fxmlLoader.<CategoryDetailController>getController();
    ...
    public void edit() {
        MainWindowController.editCategory(category, this);
    }
